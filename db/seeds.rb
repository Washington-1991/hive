...
exercise = Exercice.create(name: "Biceps", photo: "/app/assets/images/workout/biceps.jpg", time: "15m et 2m recup", repetition: "4x12", calories: "20kcl" , category: "Bras" , description: "Cet exercice est efficace pour développer la force et la taille des biceps.", workout: workout_exercise)
exercise = Exercice.create(name: "Triceps", photo: "/app/assets/images/workout/triceps.jpg", time: "15m et 2m recup", repetition: "4x12", calories: "20kcl" , category: "Bras" , description: "Cet exercice est efficace pour développer la force et la taille des triceps.", workout: workout_exercise)
exercise = Exercice.create(name: "Deltoide", photo: "/app/assets/images/workout/deltoide.jpg", time: "15m et 2m recup", repetition: "4x12", calories: "20kcl" , category: "Bras" , description: "Cet exercice est efficace pour développer la force et la taille des deltoide.", workout: workout_exercise)
exercise = Exercice.create(name: "Cuadriceps", photo: "/app/assets/images/workout/cuadriceps.jpg", time: "15m et 2m recup", repetition: "3x15", calories: "40kcl" , category: "Jambes" , description: "Un excellent exercice pour développer la force et la stabilité des quadriceps, ainsi que pour améliorer l'équilibre et la coordination", workout: workout_exercise)
...
exercise = Exercice.create(name: "Trapeze", photo: "/app/assets/images/workout/trapeze.jpg", time: "15m et 2m recup", repetition: "3x15", calories: "25kcl" , category: "Dos" , description: "Des tractions, des rotations et des positions de suspension pour renforcer les muscles du haut du corps, améliorer la stabilité du tronc et développer la coordination", workout: workout_exercise)
exercise = Exercice.create(name: "Pectoraux", photo: "/app/assets/images/workout/pecs.jpg", time: "15m et 2m recup", repetition: "4x10", calories: "30kcl" , category: "Pecs" , description: "Allongé sur un banc, tu abaisses la barre ou les alternes vers la poitrine, puis la pousses vers le haut. Cela cible les muscles pectoraux, les épaules et les triceps", workout: workout_exercise)
