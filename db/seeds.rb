...
exercise = Exercice.create(name: "Biceps", photo: "biceps.jpg", time: 15, repetition: "4x12", calories: 20, category: "Bras", description: "Cet exercice est efficace pour développer la force et la taille des biceps.", workout: workout_echauffement)
exercise = Exercice.create(name: "Triceps", photo: "triceps.jpg", time: 15, repetition: "4x12", calories: 20, category: "Bras", description: "Cet exercice est efficace pour développer la force et la taille des triceps.", workout: workout_echauffement)
exercise = Exercice.create(name: "Deltoide", photo: "deltoide.jpg", time: 15, repetition: "4x12", calories: 20, category: "Bras", description: "Cet exercice est efficace pour développer la force et la taille des deltoide.", workout: workout_echauffement)
exercise = Exercice.create(name: "Quadriceps", photo: "quadriceps.jpg", time: 15, repetition: "4x12", calories: 20, category: "Jambes", description: "Un excellent exercice pour développer la force et la stabilité des quadriceps, ainsi que pour améliorer l'équilibre et la coordination", workout: workout_echauffement)
exercise = Exercice.create(name: "Adducteurs", photo: "adducteurs.jpg", time: 15, repetition: "4x12", calories: 40, category: "Jambes", description: "Un excellent exercice pour développer la force et la stabilité des adducteurs, ainsi que pour améliorer l'équilibre et la coordination", workout: workout_echauffement)
exercise = Exercice.create(name: "Trapèze", photo: "trapeze.jpg", time: 15, repetition: "3x15", calories: 25, category: "Dos", description: "Des tractions, des rotations et des positions de suspension pour renforcer les muscles du haut du corps, améliorer la stabilité du tronc et développer la coordination", workout: workout_echauffement)
exercise = Exercice.create(name: "Pectoraux", photo: "pecs.jpg", time: 15, repetition: "4x12", calories: 30, category: "Pecs", description: "Allongé sur un banc, tu abaisses la barre ou les alternes vers la poitrine, puis la pousses vers le haut. Cela cible les muscles pectoraux, les épaules et les triceps", workout: workout_echauffement)
