...
exercise = Exercice.create!(name: "Vélo", photo: "/app/assets/images/workout/bike.jpg", time: 30, repetition: 1, calories: 80, category: "Echauffement", description: "Un échauffement sur un vélo stationnaire est un excellent moyen de préparer votre corps à l'activité physique à venir.", workout: workout_echauffement)
exercise = Exercice.create(name: "Elliptique", photo: "/app/assets/images/workout/elliptique.jpg", time: 30, repetition: 1, calories: 60, category: "Echauffement", description: "Un échauffement en elliptique stationnaire est un excellent moyen de préparer votre corps à l'activité physique à venir.", workout: workout_echauffement)
exercise = Exercice.create(name: "Biceps", photo: "/app/assets/images/workout/biceps.jpg", time: 15, repetition: 48, calories: 20, category: "Bras", description: "Cet exercice est efficace pour développer la force et la taille des biceps.", workout: workout_echauffement)
exercise = Exercice.create(name: "Triceps", photo: "/app/assets/images/workout/triceps.jpg", time: 15, repetition: 48, calories: 20, category: "Bras", description: "Cet exercice est efficace pour développer la force et la taille des triceps.", workout: workout_echauffement)
exercise = Exercice.create(name: "Deltoide", photo: "/app/assets/images/workout/deltoide.jpg", time: 15, repetition: 48, calories: 20, category: "Bras", description: "Cet exercice est efficace pour développer la force et la taille des deltoide.", workout: workout_echauffement)
exercise = Exercice.create(name: "Cuadriceps", photo: "/app/assets/images/workout/cuadriceps.jpg", time: 15, repetition: 45, calories: 20, category: "Jambes", description: "Un excellent exercice pour développer la force et la stabilité des quadriceps, ainsi que pour améliorer l'équilibre et la coordination", workout: workout_echauffement)
