...
exercise = Exercice.create(name: "Cuadriceps", photo: "Quadriceps.jpg", time: 15, repetition: 45, calories: 20, category: "Jambes", description: "Un excellent exercice pour développer la force et la stabilité des quadriceps, ainsi que pour améliorer l'équilibre et la coordination", workout: workout_echauffement)
